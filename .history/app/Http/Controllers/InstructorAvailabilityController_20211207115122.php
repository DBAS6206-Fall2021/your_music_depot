    ...
    public function update(Request $request, User $user)
    {
        ...
        // {  
            $this->validate(request(), [
                'Sunday.start' => 'date_format:H:i:s',
                'Sunday.end' => 'date_format:H:i:s',
                'Monday.start' => 'date_format:H:i:s',
                'Monday.end' => 'date_format:H:i:s',
                'Tuesday.start' => 'date_format:H:i:s',
                'Tuesday.end' => 'date_format:H:i:s',
                'Wednesday.start' => 'date_format:H:i:s',
                'Wednesday.end' => 'date_format:H:i:s',
                'Thursday.start' => 'date_format:H:i:s',
                'Thursday.end' => 'date_format:H:i:s',
                'Friday.start' => 'date_format:H:i:s',
                'Friday.end' => 'date_format:H:i:s',
                'Saturday.start' => 'date_format:H:i:s',
                'Saturday.end' => 'date_format:H:i:s',
