    ...
    public function update(Request $request, User $user)
    {
        ...
        // {  
            $this->validate(request(), [
                'Sunday.start' => ['required_unless:Sunday.end,null','date_format:H:i:s', 'before:Sunday.end'],
                'Sunday.end' => ['required_unless:Sunday.start,null','date_format:H:i:s', 'after:Sunday.start'],
