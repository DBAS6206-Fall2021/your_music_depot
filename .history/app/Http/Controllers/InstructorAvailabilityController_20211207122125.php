    ...
    public function update(Request $request, User $user)
    {
        ...
        // {  
            $this->validate(request(), [
                'Sunday.start' => ['required_unless:Sunday.start,""','date_format:H:i:s', 'before:Sunday.end'],
                'Sunday.end' => ['required_unless:Sunday.End,""','date_format:H:i:s', 'after:Sunday.start'],
