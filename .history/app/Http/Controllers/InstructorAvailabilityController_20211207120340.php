    ...
    public function update(Request $request, User $user)
    {
        ...
        // {  
            $this->validate(request(), [
                'Sunday.start' => ['required','date_format:H:i:s'],
                'Sunday.end' => ['required','date_format:H:i:s', 'after:Sunday.start'],
                'Monday.start' => ['required','date_format:H:i:s'],
                'Monday.end' => ['required','date_format:H:i:s'],
                'Tuesday.start' => ['required','date_format:H:i:s'],
                'Tuesday.end' => ['required','date_format:H:i:s'],
                'Wednesday.start' => ['required','date_format:H:i:s'],
                'Wednesday.end' => ['required','date_format:H:i:s'],
                'Thursday.start' => ['required','date_format:H:i:s'],
                'Thursday.end' => ['required','date_format:H:i:s'],
                'Friday.start' => ['required','date_format:H:i:s'],
                'Friday.end' => ['required','date_format:H:i:s'],
                'Saturday.start' => ['required','date_format:H:i:s'],
                'Saturday.end' => ['required','date_format:H:i:s'],
