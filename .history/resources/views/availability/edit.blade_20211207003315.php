            ...
            <tr class="text-center">
                ...
                <td>
                    ...
                    <select id="{{$day}}_start" name="{{$day}}_start">
                        ...
                        @for ($i = 8; $i <= 20; $i++)
                            @if (($a = $availability->firstWhere('weekday', $day)->firstWhere('start_availability', $i.":00:00")) != null) 
                            <option value="{{$i}}:00:00" {{ $a->hasStartAvailability($i.":00:00") ? "selected" : "" }}>{{$i}}:00:00</option>    
                            @else
